...
map.addControl(layerSwitcher);
    ...
    var searchLayer = new SearchLayer({
      layer: lyr_OcorrenciasRedistribuidas_7,
      colName: 'OCORRÊNCIA',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([-5192868.591081, -2700306.394766, -5189503.017085, -2697205.610402], map.getSize());
...
map.on("rendercomplete", function(evt) {
    if (!attributionComplete) {
        ...
        var quilcsAttribution = document.createElement('li');
        quilcsAttribution.innerHTML = '<a href="mailto:aquiles.coelho@gmail.com">Mapa elaborado por Aquiles Silva • </a>';
